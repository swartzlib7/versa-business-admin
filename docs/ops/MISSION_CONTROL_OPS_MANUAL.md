...
**Status:** **Outline + current-host procedures filled** (2026-08-19). Expand sections marked *TBD* as durable catalog and production packaging land.  
**Governing design:** `docs/design/spec/state/state_upgradability.md` (D1–D6 **locked**)  
**Task:** #240  
...
| `docs/design/spec/state/state_i5_6_zone_erd.md` | Zone ERD |
| `docs/design/spec/state/state_api_contract.md` | HTTP API |
| `docs/design/spec/state/state_layout_mission_ui.md` | Shell / IA |
| `docs/design/spec/state/state_records_editor_ux.md` | Records Editor / layouts |
| `docs/design/spec/state/state_db_cutover_checklist.md` | DB cutover |
...
| Gap | Impact | Tracker |
|-----|--------|---------|
| Durable catalog not fully landed | Blocks overlay impl + agent packages | #239 sequencing after Gate 3 |
| `state_upgradability.md` was missing from tree | Restored 2026-08-19 from locked D1–D6 | keep in git on next docs commit |
