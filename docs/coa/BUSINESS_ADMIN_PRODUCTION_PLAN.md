# Versa - Business Admin: Production Plan & Roadmap

**Date:** September 3, 2026  
**Status:** Living Roadmap & Strategic Sequencer  
**Project:** Versa - Business Admin (Project #26) · Game #109  
**Executive Director:** Stephen Nortje  
**Orchestrator:** Versa (COA)

**Ops outline on this tree (for review):** `docs/ops/BUSINESS_ADMIN_OPS_MANUAL.md`  
**Feature map (open first):** `docs/production/state/shape_business_admin.md`  
...
- **Living outline (this tree):** `docs/ops/BUSINESS_ADMIN_OPS_MANUAL.md` (merged from `agent/coa` `6268c1c` for review; TBDs stay TBD until catalog/packaging are sequenced).
...
- **Deliverables:**
  ...
  4. **Mission Control skill** (`business_admin`) — loadable procedure for other agents and new COAs: how to style solutions to this product, implement against the HTTP API, install a host, and operate via API / Script Tasks for other Primary Users. The manual is the human/ops source; the skill points at the manual + locked D1–D6. **Authored and marked ready 2026-09-07** (manual §2.0).
