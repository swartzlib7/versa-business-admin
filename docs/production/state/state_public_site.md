...
| **Status** | ✅ **0.7.173** time sliders: exposed 100% wait + 5–180 marks; Realistic / Stars 75% / extras On. |
...
| WU-13 | Ship Realistic + screenshot sky preset as product defaults (Stars 75%, density 7×, extras On, comet/aurora ½×) | WU-12 | ✅ | ⬜ | 🔧 | IDE |
...
| 2026-09-10 | Sky time sliders | **0.7.173:** Expose each effect’s 100% wait (picklist seconds) and a Wait slider on 5–180% of that value; marks show computed seconds. Current frequency snaps to the closest mark. |
