...
| **Status** | 🔧 **0.7.161** aurora reworked as small scattered patches (Off by default). Awaiting Stephen QA |
...
Matches §1 on beta `:3200` through **0.7.161** local (aurora patches). **0.7.158** remains on origin/master. 0.7.159 blobs and 0.7.160 corner curtains were rejected; 0.7.161 is scattered small patches, Off by default. WU-12 is task **#289** — agent-verified, awaiting Stephen QA. WU-07 / WU-08 / WU-09 accepted 2026-09-05. Comet palettes (WU-11) accepted 2026-09-07.
...
| WU-12 | Aurora: 1–3 small soft rippling patches (150–450 × 100–250) at random spots per interval; **Off by default**. 0.7.159 blobs + 0.7.160 curtains rejected. Perf pause-when-hidden stays. | WU-05 | ✅ | ⬜ | 🔧 | 289 |
...
| 2026-09-09 | Aurora patches | **0.7.161:** 1–3 small soft gradient patches per interval at random spots, long-wave ripple, faded all sides, 150–450 × 100–250. Off by default. Local `beta`, not pushed. | Stephen visual QA |
