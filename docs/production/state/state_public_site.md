...
| **Status** | 🔧 **0.7.160** legit aurora curtains shipped locally (Off by default). Awaiting Stephen QA |
...
Matches §1 on beta `:3200` through **0.7.160** local (aurora redo). **0.7.158** remains on origin/master. 0.7.159 first-pass aurora was rejected; 0.7.160 rebuilds curtains and defaults Off. WU-12 is task **#289** — agent-verified, awaiting Stephen QA. WU-07 / WU-08 / WU-09 accepted 2026-09-05. Comet palettes (WU-11) accepted 2026-09-07.
...
| WU-12 | Aurora: real northern-light curtains (top-half corners, 3–8s, 90–360s); **Off by default**. 0.7.159 first pass rejected (cheap). Perf pause-when-hidden can stay. | WU-05 | ✅ | ⬜ | 🔧 | 289 |
...
| 2026-09-09 | Aurora redo | **0.7.160:** vertical curtain sheets (rays + fold-edge brightening), Off by default. Review board still On from the 0.7.159 save. Local `beta`, not pushed. | Stephen visual QA |
