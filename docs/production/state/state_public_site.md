...
| **Status** | 🔧 **0.7.159** first-pass aurora rejected (looks cheap). Next: legit curtains, **Off by default** |
...
Matches §1 on beta `:3200` through **0.7.158** on origin/master (listing/sky-preview/min-height). **0.7.159** first-pass aurora is on local `beta` (`b493ca8`, not pushed); Stephen rejected the look 2026-09-09. WU-12 redo is task **#289**. WU-07 / WU-08 / WU-09 accepted 2026-09-05. Comet palettes (WU-11) accepted 2026-09-07.
