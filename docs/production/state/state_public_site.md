...
| **Status** | ✅ **0.7.178** Switch labeled Randomize Frequency; Density under Stars; ±5s card beside Aurora. |
...
| WU-13 | Ship Realistic + screenshot sky preset as product defaults (Stars 75%, density 7×, extras On, Frequency 30/10/50/120/90s) | WU-12 | ✅ | ⬜ | 🔧 | IDE |
...
| 2026-09-10 | Ship sky preset | Stephen attached Settings values and asked to ship Realistic as the default. | **0.7.171** first pass (Stars 100% / extras Off) |
| 2026-09-10 | Sky preset correction | Stephen: extras On; Stars 75% as on the board before 0.7.171. | **0.7.172** |
| 2026-09-10 | Dual wait sliders | Extra 100% + Wait % on 5–180 marks. | **0.7.173** (superseded) |
| 2026-09-10 | One Frequency scale | Drop the extra slider and × fractions. Every effect uses 5–180s; park on coded defaults. | **0.7.174** |
| 2026-09-10 | Frequency defaults | Stephen: shooting stars 30s, satellites 10s, asteroids 50s, comets 120s, aurora 90s. | **0.7.175** |
| 2026-09-10 | Frequency jitter | Was a % band (0.75–1.4×, plus special first-spawn / aurora 1–4×). Now ±5s on every Frequency. | **0.7.176** |
| 2026-09-10 | Random sequence | Slider is first wait only when Random sequence is On. Density under Stars. ±5s card beside Aurora. | **0.7.177** |
| 2026-09-10 | Label | Switch renamed to **Randomize Frequency**. | **0.7.178** |
...
| 2026-09-10 | Sky ship preset | **0.7.171:** Stephen: ship with Sky Animation **Realistic** and the attached Settings values. First pass wrote Stars 100% and extras Off. |
| 2026-09-10 | Sky preset correction | **0.7.172:** Stephen: extras On; Stars back to 75%. Density 7×, comet/aurora ½×, Full-Screen Off unchanged. This review board rewritten to the corrected preset. |
| 2026-09-10 | Sky time sliders | **0.7.173:** Extra 100% slider plus Wait % — superseded. |
| 2026-09-10 | Frequency seconds | **0.7.174:** Remove the extra slider. Frequency uses 5–180s for every effect; each starts on its coded default (10 / 15 / 40 / 50 / 90). |
| 2026-09-10 | Frequency defaults | **0.7.175:** System defaults — shooting stars 30s, satellites 10s, asteroids 50s, comets 120s, aurora 90s. |
| 2026-09-10 | Frequency jitter | **0.7.176:** Live wait is Frequency ±5s on every effect (floor 1s). Drops the old 0.75–1.4× band and aurora 1–4× quiet. Preview still short-circuits. |
| 2026-09-10 | Random sequence | **0.7.177:** Per-effect **Random sequence** (On by default). Slider is the first wait; later waits pick another 5–180 mark, still ±5s. Density sits under Stars. Frequency variation card next to Aurora. |
| 2026-09-10 | Label | **0.7.178:** Switch and variation card say **Randomize Frequency**. |
