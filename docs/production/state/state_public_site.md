...
| **Status** | ✅ **0.7.174** Frequency sliders share 5–180s; each parked on its coded default. |
...
| WU-13 | Ship Realistic + screenshot sky preset as product defaults (Stars 75%, density 7×, extras On, Frequency 10/15/40/50/90s) | WU-12 | ✅ | ⬜ | 🔧 | IDE |
