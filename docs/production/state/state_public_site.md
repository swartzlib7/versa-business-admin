...
| **Status** | 🔧 **0.7.159** — Aurora curtains; sky loop pauses when the tab is hidden |
...
| WU-12 | Aurora curtains (top-half corners, 3–8s, 90–360s); pause hidden-tab rAF | WU-05 | ⬜ | ⬜ | 🔧 | |
...
| 2026-09-08 | Night-sky aurora | **0.7.159:** Aurora On by default — green/teal/magenta curtains from a top corner, 3–8s, then 90–360s quiet (1×). Sky Animation preview first-shows in a few seconds. Loop pauses when the tab is hidden; faint stars skipped; duplicate mousemove listener removed. |
