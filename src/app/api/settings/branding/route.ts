...
export async function PUT(request: Request) {
  ...
  let brandMusicLoop: boolean | undefined;
  if (typeof body.brand_music_loop === "boolean") {
    brandMusicLoop = body.brand_music_loop;
  }
  let brandMusicAutoplay: boolean | undefined;
  if (typeof body.brand_music_autoplay === "boolean") {
    brandMusicAutoplay = body.brand_music_autoplay;
  }
  let brandNameInMenu: boolean | undefined;
  if (typeof body.brand_name_in_menu === "boolean") {
    brandNameInMenu = body.brand_name_in_menu;
  }
  let clearMusic = false;
  if (body.brand_music_url === null || body.brand_music_url === "") {
    clearMusic = true;
  }
  ...
  try {
    ...
    if (
      clearMusic ||
      brandMusicLoop !== undefined ||
      brandMusicAutoplay !== undefined ||
      brandNameInMenu !== undefined
    ) {
      upsertSiteSettingsFixture({
        brand_music_url: clearMusic ? null : undefined,
        brand_music_name: clearMusic ? null : undefined,
        brand_music_loop: brandMusicLoop,
        brand_music_autoplay: brandMusicAutoplay,
        brand_name_in_menu: brandNameInMenu,
      });
    }
    const fromSettings =
      "brand_logo_url" in settings
