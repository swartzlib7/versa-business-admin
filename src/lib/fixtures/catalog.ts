...
const facultyRecordFieldSeedBase: FieldDefinition[] = [
  ...
  { id: 'fld-render_driver-compatible_record_type', object_api_name: 'render_driver', api_name: 'compatible_record_type', label: 'Record type', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true, zone_role: 'header' },
  ...
  { id: 'fld-render_driver-recipe_key', object_api_name: 'render_driver', api_name: 'recipe_key', label: 'Recipe key', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-render_driver-recipe_label', object_api_name: 'render_driver', api_name: 'recipe_label', label: 'Recipe', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 80, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-render_driver-recipe_tiles', object_api_name: 'render_driver', api_name: 'recipe_tiles', label: 'Tiles', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 90, active: true, zone_role: 'list', show_in_column: true },
  ...
  { id: 'fld-driver_pairing-target_record_type', object_api_name: 'driver_pairing', api_name: 'target_record_type', label: 'Target type', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 30, active: true },
  { id: 'fld-driver_pairing-target_record_id', object_api_name: 'driver_pairing', api_name: 'target_record_id', label: 'Target id', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true },
  { id: 'fld-driver_pairing-target_kind', object_api_name: 'driver_pairing', api_name: 'target_kind', label: 'Target kind', data_type: 'picklist', is_system: true, is_required: true, default_value: 'header', value_set_api_name: 'driver_pairing_target_kind', lookup_object_api_name: null, sort_order: 50, active: true },
  { id: 'fld-driver_pairing-input_map_json', object_api_name: 'driver_pairing', api_name: 'input_map_json', label: 'Input map', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 60, active: true },
  { id: 'fld-driver_pairing-record_mode', object_api_name: 'driver_pairing', api_name: 'record_mode', label: 'Record mode', data_type: 'picklist', is_system: true, is_required: false, default_value: 'single', value_set_api_name: 'driver_pairing_record_mode', lookup_object_api_name: null, sort_order: 70, active: true },
  { id: 'fld-driver_pairing-filter_json', object_api_name: 'driver_pairing', api_name: 'filter_json', label: 'Filter', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 80, active: true },
  { id: 'fld-driver_pairing-page_size', object_api_name: 'driver_pairing', api_name: 'page_size', label: 'Page size', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 90, active: true },
  { id: 'fld-driver_pairing-page', object_api_name: 'driver_pairing', api_name: 'page', label: 'Page', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 100, active: true },
