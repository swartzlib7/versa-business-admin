...
import { PLATFORM_DEFAULT_FIELDS } from '@/lib/catalog/platform-fields';
...
export interface FieldDefinition {
  ...
  /** Mask on screen (Show / Hide). Stored value is unchanged. */
  is_secret?: boolean;
}
...
export const valueSets: ValueSet[] = [
  ...
  {
    id: 'vs-stat-frequency-type',
    api_name: 'stat_frequency_type',
    label: 'Stat frequency type',
    description: 'Frequency axis type for a Statistics header (S-4)',
  },
  {
    id: 'vs-stat-series-mode',
    api_name: 'stat_series_mode',
    label: 'Stat series mode',
    description: 'Series behavior for a Statistics header: Dynamic Series or Single Series (S-4)',
  },
  {
    id: 'vs-record-status',
  ...
  },
  {
    ...
    description: 'Primary Org is internal and is_primary. Additional own businesses are also Org (internal). Collaboration parties are vendor, customer, partner, or branch (subsidiary).',
  },
  {
    id: 'vs-staff-role',
    api_name: 'staff_role',
  ...
  {
    id: 'vs-public-html-slot',
    api_name: 'public_html_slot',
    label: 'Public HTML slot',
    description: 'Which homepage section this HTML page paints.',
  },
  {
    id: 'vs-page-body-format',
    api_name: 'page_body_format',
    label: 'Page body format',
    description: 'Render a Page body as Text or HTML.',
  },
  {
    id: 'vs-policy-status',
  ...
  {
    id: 'vs-document-status',
    api_name: 'document_status',
    label: 'Document status',
    description: 'Invoice, estimate, and transaction statuses (AGi Org / Wave vocab).',
  },
  {
    id: 'vs-product-kind',
    api_name: 'product_kind',
    label: 'Product kind',
    description: 'AGi products.type: service, product, subscription, expense.',
  },
  {
    id: 'vs-page-element-kind',
    api_name: 'page_element_kind',
    label: 'Element kind',
    description: 'How a Page Builder Element binds: feature, record type, or homepage row.',
  },
  {
    id: 'vs-page-element-driver',
    api_name: 'page_element_driver',
    label: 'Element driver',
    description: 'Rendering driver the Page Builder Cell asks to paint.',
  },
  {
    id: 'vs-render-driver-bind-shape',
    api_name: 'render_driver_bind_shape',
    label: 'Driver bind shape',
    description: 'Driver header shape: header only, header + lines, or lines only.',
  },
  {
    id: 'vs-driver-pairing-target-kind',
    api_name: 'driver_pairing_target_kind',
    label: 'Pairing target kind',
    description: 'Header or lines scope for a Driver pairing.',
  },
  {
    id: 'vs-driver-pairing-record-mode',
    api_name: 'driver_pairing_record_mode',
    label: 'Pairing record mode',
    description: 'Single record, iterate a list, or rollup.',
  },
  {
    id: 'vs-driver-pairing-selection-mode',
    api_name: 'driver_pairing_selection_mode',
    label: 'Element record selection',
    description: 'One record, a filter, or all records of the driver type.',
  },
];
...
export const valueSetItems: ValueSetItem[] = [
  ...
  {
    id: 'vsi-ik-accounting',
    value_set_id: 'vs-integration-kind',
    api_value: 'accounting',
    label: 'Accounting',
    sort_order: 60,
    active: true,
  },
  ...
  {
    id: 'vsi-sft-sec',
    value_set_id: 'vs-stat-frequency-type',
    api_value: 'sec',
    label: 'Sec',
    sort_order: 10,
    active: true,
  ...
  {
    id: 'vsi-ssm-dynamic',
    value_set_id: 'vs-stat-series-mode',
    api_value: 'dynamic',
  ...
  { id: 'vsi-phs-facets', value_set_id: 'vs-public-html-slot', api_value: 'facets', label: 'Facets', sort_order: 10, active: true },
  { id: 'vsi-phs-about', value_set_id: 'vs-public-html-slot', api_value: 'about', label: 'About', sort_order: 20, active: true },
  { id: 'vsi-phs-contact', value_set_id: 'vs-public-html-slot', api_value: 'contacts', label: 'Contacts', sort_order: 30, active: false },
  ...
  { id: 'vsi-cat-imap', value_set_id: 'vs-credential-auth-type', api_value: 'imap', label: 'IMAP', sort_order: 60, active: true },
  { id: 'vsi-cat-mcp', value_set_id: 'vs-credential-auth-type', api_value: 'mcp', label: 'MCP', sort_order: 70, active: true },
  { id: 'vsi-cat-api', value_set_id: 'vs-credential-auth-type', api_value: 'api', label: 'API', sort_order: 80, active: true },
  ...
  { id: 'vsi-eo-agent', value_set_id: 'vs-exchange-origin', api_value: 'agent', label: 'Agent', sort_order: 30, active: true },
  { id: 'vsi-eo-user', value_set_id: 'vs-exchange-origin', api_value: 'user', label: 'User', sort_order: 40, active: true },
  { id: 'vsi-eo-integration', value_set_id: 'vs-exchange-origin', api_value: 'integration', label: 'Integration', sort_order: 50, active: true },
  ...
  { id: 'vsi-es-new', value_set_id: 'vs-exchange-status', api_value: 'new', label: 'New', sort_order: 40, active: true },
  { id: 'vsi-es-sync-done', value_set_id: 'vs-exchange-status', api_value: 'sync-done', label: 'Sync done', sort_order: 50, active: true },
  { id: 'vsi-es-sync-failed', value_set_id: 'vs-exchange-status', api_value: 'sync-failed', label: 'Sync failed', sort_order: 60, active: true },
  { id: 'vsi-ds-draft', value_set_id: 'vs-document-status', api_value: 'draft', label: 'Draft', sort_order: 10, active: true },
  { id: 'vsi-ds-sent', value_set_id: 'vs-document-status', api_value: 'sent', label: 'Sent', sort_order: 20, active: true },
  { id: 'vsi-ds-viewed', value_set_id: 'vs-document-status', api_value: 'viewed', label: 'Viewed', sort_order: 30, active: true },
  { id: 'vsi-ds-partial', value_set_id: 'vs-document-status', api_value: 'partial', label: 'Partial', sort_order: 40, active: true },
  { id: 'vsi-ds-overdue', value_set_id: 'vs-document-status', api_value: 'overdue', label: 'Overdue', sort_order: 50, active: true },
  { id: 'vsi-ds-paid', value_set_id: 'vs-document-status', api_value: 'paid', label: 'Paid', sort_order: 60, active: true },
  { id: 'vsi-ds-accepted', value_set_id: 'vs-document-status', api_value: 'accepted', label: 'Accepted', sort_order: 70, active: true },
  { id: 'vsi-ds-declined', value_set_id: 'vs-document-status', api_value: 'declined', label: 'Declined', sort_order: 80, active: true },
  { id: 'vsi-ds-expired', value_set_id: 'vs-document-status', api_value: 'expired', label: 'Expired', sort_order: 90, active: true },
  { id: 'vsi-ds-invoiced', value_set_id: 'vs-document-status', api_value: 'invoiced', label: 'Invoiced', sort_order: 100, active: true },
  { id: 'vsi-ds-converted', value_set_id: 'vs-document-status', api_value: 'converted', label: 'Converted', sort_order: 110, active: true },
  { id: 'vsi-ds-active', value_set_id: 'vs-document-status', api_value: 'active', label: 'Active', sort_order: 120, active: true },
  { id: 'vsi-pk-product', value_set_id: 'vs-product-kind', api_value: 'product', label: 'Product', sort_order: 10, active: true },
  { id: 'vsi-pk-service', value_set_id: 'vs-product-kind', api_value: 'service', label: 'Service', sort_order: 20, active: true },
  { id: 'vsi-pk-subscription', value_set_id: 'vs-product-kind', api_value: 'subscription', label: 'Subscription', sort_order: 30, active: true },
  { id: 'vsi-pk-expense', value_set_id: 'vs-product-kind', api_value: 'expense', label: 'Expense', sort_order: 40, active: true },
  { id: 'vsi-pek-feature', value_set_id: 'vs-page-element-kind', api_value: 'feature', label: 'Feature', sort_order: 10, active: true },
  { id: 'vsi-pek-record', value_set_id: 'vs-page-element-kind', api_value: 'record', label: 'Record type', sort_order: 20, active: true },
  { id: 'vsi-pek-home', value_set_id: 'vs-page-element-kind', api_value: 'home', label: 'Homepage row', sort_order: 30, active: true },
  { id: 'vsi-ped-cycle', value_set_id: 'vs-page-element-driver', api_value: 'cycle-strip', label: 'Cycle Strip', sort_order: 10, active: true },
  { id: 'vsi-ped-glossary', value_set_id: 'vs-page-element-driver', api_value: 'glossary-book', label: 'Glossary of Terms', sort_order: 20, active: true },
  { id: 'vsi-ped-org', value_set_id: 'vs-page-element-driver', api_value: 'org-board', label: 'Org Board', sort_order: 30, active: true },
  { id: 'vsi-ped-stat', value_set_id: 'vs-page-element-driver', api_value: 'stat-graph', label: 'Statistics graph', sort_order: 40, active: true },
  { id: 'vsi-ped-html', value_set_id: 'vs-page-element-driver', api_value: 'html-block', label: 'HTML page', sort_order: 50, active: true },
  { id: 'vsi-ped-support', value_set_id: 'vs-page-element-driver', api_value: 'home:inspections-reports', label: 'Inspections & Reports', sort_order: 60, active: true },
  { id: 'vsi-ped-facets', value_set_id: 'vs-page-element-driver', api_value: 'home:facets', label: 'Facets', sort_order: 70, active: true },
  { id: 'vsi-ped-integ', value_set_id: 'vs-page-element-driver', api_value: 'home:integrations', label: 'Integrations', sort_order: 80, active: true },
  { id: 'vsi-ped-metrics', value_set_id: 'vs-page-element-driver', api_value: 'home:statistics', label: 'Statistics', sort_order: 90, active: true },
  { id: 'vsi-ped-knowledge', value_set_id: 'vs-page-element-driver', api_value: 'home:knowledge', label: 'Knowledge', sort_order: 100, active: true },
  { id: 'vsi-ped-about', value_set_id: 'vs-page-element-driver', api_value: 'home:about', label: 'About', sort_order: 110, active: true },
  { id: 'vsi-ped-contact', value_set_id: 'vs-page-element-driver', api_value: 'home:contacts', label: 'Contacts', sort_order: 120, active: true },
  { id: 'vsi-rdbs-header', value_set_id: 'vs-render-driver-bind-shape', api_value: 'header', label: 'Header only', sort_order: 10, active: true },
  { id: 'vsi-rdbs-lines-list', value_set_id: 'vs-render-driver-bind-shape', api_value: 'lines_list', label: 'Header + lines', sort_order: 20, active: true },
  { id: 'vsi-rdbs-line-single', value_set_id: 'vs-render-driver-bind-shape', api_value: 'line_single', label: 'Header + lines (one line)', sort_order: 30, active: true },
  { id: 'vsi-rdbs-lines-only', value_set_id: 'vs-render-driver-bind-shape', api_value: 'lines_only', label: 'Lines only', sort_order: 40, active: true },
  { id: 'vsi-dptk-header', value_set_id: 'vs-driver-pairing-target-kind', api_value: 'header', label: 'Header', sort_order: 10, active: true },
  { id: 'vsi-dptk-lines', value_set_id: 'vs-driver-pairing-target-kind', api_value: 'lines', label: 'Lines', sort_order: 20, active: true },
  { id: 'vsi-dprm-single', value_set_id: 'vs-driver-pairing-record-mode', api_value: 'single', label: 'Single', sort_order: 10, active: true },
  { id: 'vsi-dprm-list', value_set_id: 'vs-driver-pairing-record-mode', api_value: 'list', label: 'List', sort_order: 20, active: true },
  { id: 'vsi-dprm-rollup', value_set_id: 'vs-driver-pairing-record-mode', api_value: 'rollup', label: 'Rollup', sort_order: 30, active: true },
  { id: 'vsi-dpsm-one', value_set_id: 'vs-driver-pairing-selection-mode', api_value: 'one', label: 'One record', sort_order: 10, active: true },
  { id: 'vsi-dpsm-filter', value_set_id: 'vs-driver-pairing-selection-mode', api_value: 'filter', label: 'Filter', sort_order: 20, active: true },
  { id: 'vsi-dpsm-all', value_set_id: 'vs-driver-pairing-selection-mode', api_value: 'all', label: 'All records', sort_order: 30, active: true },
];
...
export const layoutDefinitions: LayoutDefinition[] = [
      ...
      sections: [
        {
          ...
          label: 'Columns',
          columns: 1,
          fields: ['name', 'email', 'role', 'type', 'status'],
        },
      ],
    },
  },
  ...
  {
    id: 'lay-environment_stat-detail-default',
    object_api_name: 'statistics',
    api_name: 'environment_stat_detail_default',
    label: 'Statistic header (default)',
    layout_type: 'detail',
    version: 1,
    is_default: true,
    body: {
      sections: [
        {
          id: 'sec-stat-identity',
          label: 'Statistic',
          columns: 2,
          fields: ['name', 'series_mode'],
        },
        {
          id: 'sec-stat-scale',
          label: 'Scale',
          columns: 2,
          fields: ['scale_name', 'scale_start', 'scale_end', 'scale_step'],
        },
        {
          id: 'sec-stat-frequency',
          label: 'Frequency',
          columns: 2,
          fields: ['frequency_type', 'frequency_start', 'frequency_qty', 'start_datetime'],
        },
        {
          id: 'sec-stat-audit',
          label: 'Audit',
  ...
  {
    id: 'lay-environment_stat-edit-default',
    object_api_name: 'statistics',
    api_name: 'environment_stat_edit_default',
    label: 'Statistic header edit (default)',
    layout_type: 'edit',
    version: 1,
    is_default: true,
    body: {
  ...
  {
    id: 'lay-environment_stat-list-default',
    object_api_name: 'statistics',
    api_name: 'environment_stat_list_default',
    label: 'Statistic list (default)',
    layout_type: 'list',
    version: 1,
    is_default: true,
    body: {
...
const facultyRecordFieldSeedBase: FieldDefinition[] = [
  ...
  { id: 'fld-executive_task-project_id', object_api_name: 'executive_task', api_name: 'project_id', label: 'Project', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'executive_project', sort_order: 15, active: true, zone_role: 'header' },
  ...
  { id: 'fld-production_product-organization_id', object_api_name: 'production_product', api_name: 'organization_id', label: 'Organization', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'organization', sort_order: 22, active: true, zone_role: 'header' },
  { id: 'fld-production_product-product_kind', object_api_name: 'production_product', api_name: 'product_kind', label: 'Kind', data_type: 'picklist', is_system: true, is_required: false, default_value: 'product', value_set_api_name: 'product_kind', lookup_object_api_name: null, sort_order: 21, active: true, zone_role: 'header' },
  { id: 'fld-production_product-currency', object_api_name: 'production_product', api_name: 'currency', label: 'Currency', data_type: 'text', is_system: true, is_required: false, default_value: 'USD', value_set_api_name: null, lookup_object_api_name: null, sort_order: 26, active: true, zone_role: 'header' },
  { id: 'fld-production_product-is_active', object_api_name: 'production_product', api_name: 'is_active', label: 'Active', data_type: 'boolean', is_system: true, is_required: false, default_value: 'true', value_set_api_name: null, lookup_object_api_name: null, sort_order: 41, active: true, zone_role: 'header' },
  ...
  { id: 'fld-production_service-organization_id', object_api_name: 'production_service', api_name: 'organization_id', label: 'Organization', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'organization', sort_order: 25, active: true, zone_role: 'header' },
  { id: 'fld-production_service-external_id', object_api_name: 'production_service', api_name: 'external_id', label: 'External id', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: true, zone_role: 'header' },
  ...
  // treasury_transaction_classification, plus existing record_status / event_kind /
  ...
  { id: 'fld-communication_report-name', object_api_name: 'inspection_report', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true },
  { id: 'fld-communication_report-status', object_api_name: 'inspection_report', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: null, value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 20, active: true },
  { id: 'fld-communication_report-summary', object_api_name: 'inspection_report', api_name: 'summary', label: 'Summary', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 30, active: true },
  { id: 'fld-communication_report-notes', object_api_name: 'inspection_report', api_name: 'notes', label: 'Data', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true },
  { id: 'fld-communication_report-ticket_subject', object_api_name: 'inspection_report', api_name: 'ticket_subject', label: 'Ticket subject', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 50, active: false },
  { id: 'fld-communication_report-ticket_status', object_api_name: 'inspection_report', api_name: 'ticket_status', label: 'Ticket status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'open', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 60, active: false },
  { id: 'fld-communication_report-ticket_notes', object_api_name: 'inspection_report', api_name: 'ticket_notes', label: 'Ticket notes', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: false },
  { id: 'fld-custom-name', object_api_name: 'custom', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true },
  { id: 'fld-custom-notes', object_api_name: 'custom', api_name: 'notes', label: 'Notes', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 20, active: true },
  { id: 'fld-custom-status', object_api_name: 'custom', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 30, active: true },
  { id: 'fld-public_html-name', object_api_name: 'page', api_name: 'name', label: 'Title', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true },
  { id: 'fld-public_html-slot', object_api_name: 'page', api_name: 'slot', label: 'Homepage slot', data_type: 'picklist', is_system: true, is_required: false, default_value: 'custom', value_set_api_name: 'public_html_slot', lookup_object_api_name: null, sort_order: 20, active: false },
  { id: 'fld-public_html-status', object_api_name: 'page', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 30, active: true },
  { id: 'fld-public_html-body_format', object_api_name: 'page', api_name: 'body_format', label: 'Render as', data_type: 'picklist', is_system: true, is_required: false, default_value: 'html', value_set_api_name: 'page_body_format', lookup_object_api_name: null, sort_order: 35, active: true },
  { id: 'fld-public_html-body_html', object_api_name: 'page', api_name: 'body_html', label: 'Body', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true },
  { id: 'fld-page_element-name', object_api_name: 'page_element', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true },
  { id: 'fld-page_element-driver', object_api_name: 'page_element', api_name: 'driver', label: 'Driver', data_type: 'picklist', is_system: true, is_required: true, default_value: 'html-block', value_set_api_name: 'page_element_driver', lookup_object_api_name: null, sort_order: 20, active: true },
  { id: 'fld-page_element-kind', object_api_name: 'page_element', api_name: 'kind', label: 'Kind', data_type: 'picklist', is_system: true, is_required: true, default_value: 'feature', value_set_api_name: 'page_element_kind', lookup_object_api_name: null, sort_order: 30, active: true },
  { id: 'fld-page_element-record_type', object_api_name: 'page_element', api_name: 'record_type', label: 'Record type', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true },
  { id: 'fld-page_element-feature_id', object_api_name: 'page_element', api_name: 'feature_id', label: 'Feature id', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 50, active: true },
  { id: 'fld-page_element-preview', object_api_name: 'page_element', api_name: 'preview', label: 'Preview note', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 60, active: true },
  { id: 'fld-page_element-description', object_api_name: 'page_element', api_name: 'description', label: 'Description', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: true },
  { id: 'fld-page_element-status', object_api_name: 'page_element', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 80, active: true },
  { id: 'fld-cycle_strip-name', object_api_name: 'cycle_strip', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-name_enabled', object_api_name: 'cycle_strip', api_name: 'name_enabled', label: 'Show name', data_type: 'boolean', is_system: true, is_required: false, default_value: 'true', value_set_api_name: null, lookup_object_api_name: null, sort_order: 20, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-number', object_api_name: 'cycle_strip', api_name: 'number', label: 'Number', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 30, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-number_enabled', object_api_name: 'cycle_strip', api_name: 'number_enabled', label: 'Show number', data_type: 'boolean', is_system: true, is_required: false, default_value: 'true', value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-description', object_api_name: 'cycle_strip', api_name: 'description', label: 'Description', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 50, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-description_enabled', object_api_name: 'cycle_strip', api_name: 'description_enabled', label: 'Show description', data_type: 'boolean', is_system: true, is_required: false, default_value: 'true', value_set_api_name: null, lookup_object_api_name: null, sort_order: 60, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-sort_order', object_api_name: 'cycle_strip', api_name: 'sort_order', label: 'Sort order', data_type: 'number', is_system: true, is_required: false, default_value: '10', value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: true, zone_role: 'header' },
  { id: 'fld-cycle_strip-status', object_api_name: 'cycle_strip', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 80, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-name', object_api_name: 'render_driver', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-code_key', object_api_name: 'render_driver', api_name: 'code_key', label: 'Code key', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 20, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-bind_shape', object_api_name: 'render_driver', api_name: 'bind_shape', label: 'Shape', data_type: 'picklist', is_system: true, is_required: true, default_value: 'header', value_set_api_name: 'render_driver_bind_shape', lookup_object_api_name: null, sort_order: 30, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-compatible_record_type', object_api_name: 'render_driver', api_name: 'compatible_record_type', label: 'Record type', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'record_type', sort_order: 40, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-description', object_api_name: 'render_driver', api_name: 'description', label: 'Description', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 50, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-status', object_api_name: 'render_driver', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 60, active: true, zone_role: 'header' },
  { id: 'fld-render_driver-recipe_key', object_api_name: 'render_driver', api_name: 'recipe_key', label: 'Recipe key', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: false, zone_role: 'list', show_in_column: true },
  { id: 'fld-render_driver-recipe_label', object_api_name: 'render_driver', api_name: 'recipe_label', label: 'Recipe', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 80, active: false, zone_role: 'list', show_in_column: true },
  { id: 'fld-render_driver-recipe_tiles', object_api_name: 'render_driver', api_name: 'recipe_tiles', label: 'Tiles', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 90, active: false, zone_role: 'list', show_in_column: true },
  { id: 'fld-render_driver-inputs_json', object_api_name: 'render_driver', api_name: 'inputs_json', label: 'Inputs', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 200, active: false, zone_role: 'header' },
  { id: 'fld-render_driver-outputs_json', object_api_name: 'render_driver', api_name: 'outputs_json', label: 'Outputs', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 210, active: false, zone_role: 'header' },
  { id: 'fld-render_driver-supports_filter', object_api_name: 'render_driver', api_name: 'supports_filter', label: 'Supports filter', data_type: 'boolean', is_system: true, is_required: false, default_value: 'false', value_set_api_name: null, lookup_object_api_name: null, sort_order: 220, active: false, zone_role: 'header' },
  { id: 'fld-render_driver-supports_pagination', object_api_name: 'render_driver', api_name: 'supports_pagination', label: 'Supports pagination', data_type: 'boolean', is_system: true, is_required: false, default_value: 'false', value_set_api_name: null, lookup_object_api_name: null, sort_order: 230, active: false, zone_role: 'header' },
  { id: 'fld-driver_pairing-name', object_api_name: 'driver_pairing', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true },
  { id: 'fld-driver_pairing-driver_id', object_api_name: 'driver_pairing', api_name: 'driver_id', label: 'Driver', data_type: 'lookup', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: 'render_driver', sort_order: 20, active: true },
  { id: 'fld-driver_pairing-render_option', object_api_name: 'driver_pairing', api_name: 'render_option', label: 'Render Option', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 25, active: true },
  { id: 'fld-driver_pairing-target_record_type', object_api_name: 'driver_pairing', api_name: 'target_record_type', label: 'Record type', data_type: 'lookup', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: 'record_type', sort_order: 30, active: true },
  { id: 'fld-driver_pairing-selection_mode', object_api_name: 'driver_pairing', api_name: 'selection_mode', label: 'Selection Type', data_type: 'picklist', is_system: true, is_required: true, default_value: 'one', value_set_api_name: 'driver_pairing_selection_mode', lookup_object_api_name: null, sort_order: 35, active: true },
  { id: 'fld-driver_pairing-target_record_id', object_api_name: 'driver_pairing', api_name: 'target_record_id', label: 'Record', data_type: 'lookup', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: 'record', sort_order: 40, active: true },
  { id: 'fld-driver_pairing-target_kind', object_api_name: 'driver_pairing', api_name: 'target_kind', label: 'Target kind', data_type: 'picklist', is_system: true, is_required: true, default_value: 'header', value_set_api_name: 'driver_pairing_target_kind', lookup_object_api_name: null, sort_order: 50, active: false },
  { id: 'fld-driver_pairing-input_map_json', object_api_name: 'driver_pairing', api_name: 'input_map_json', label: 'Input map', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 60, active: false },
  { id: 'fld-driver_pairing-record_mode', object_api_name: 'driver_pairing', api_name: 'record_mode', label: 'Record mode', data_type: 'picklist', is_system: true, is_required: false, default_value: 'single', value_set_api_name: 'driver_pairing_record_mode', lookup_object_api_name: null, sort_order: 70, active: false },
  { id: 'fld-driver_pairing-filter_json', object_api_name: 'driver_pairing', api_name: 'filter_json', label: 'Filter', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 42, active: true },
  { id: 'fld-driver_pairing-page_size', object_api_name: 'driver_pairing', api_name: 'page_size', label: 'Page size', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 90, active: false },
  { id: 'fld-driver_pairing-page', object_api_name: 'driver_pairing', api_name: 'page', label: 'Page', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 100, active: false },
  { id: 'fld-driver_pairing-status', object_api_name: 'driver_pairing', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 110, active: true },
  ...
  { id: 'fld-treasury_transaction-document_number', object_api_name: 'treasury_transaction', api_name: 'document_number', label: 'Document number', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 13, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-classification', object_api_name: 'treasury_transaction', api_name: 'classification', label: 'Classification', data_type: 'picklist', is_system: true, is_required: false, default_value: null, value_set_api_name: 'treasury_transaction_classification', lookup_object_api_name: null, sort_order: 20, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-transaction_date', object_api_name: 'treasury_transaction', api_name: 'transaction_date', label: 'Date', data_type: 'date', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 15, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-due_date', object_api_name: 'treasury_transaction', api_name: 'due_date', label: 'Due date', data_type: 'date', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 16, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-paid_date', object_api_name: 'treasury_transaction', api_name: 'paid_date', label: 'Paid date', data_type: 'date', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 17, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-expiry_date', object_api_name: 'treasury_transaction', api_name: 'expiry_date', label: 'Expiry date', data_type: 'date', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 18, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-amount', object_api_name: 'treasury_transaction', api_name: 'amount', label: 'Amount', data_type: 'currency', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 30, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-subtotal', object_api_name: 'treasury_transaction', api_name: 'subtotal', label: 'Subtotal', data_type: 'currency', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 31, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-tax_total', object_api_name: 'treasury_transaction', api_name: 'tax_total', label: 'Tax', data_type: 'currency', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 32, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-currency', object_api_name: 'treasury_transaction', api_name: 'currency', label: 'Currency', data_type: 'text', is_system: true, is_required: false, default_value: 'USD', value_set_api_name: null, lookup_object_api_name: null, sort_order: 35, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-category', object_api_name: 'treasury_transaction', api_name: 'category', label: 'Category', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 25, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-status', object_api_name: 'treasury_transaction', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: null, value_set_api_name: 'document_status', lookup_object_api_name: null, sort_order: 40, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-issuer_organization_id', object_api_name: 'treasury_transaction', api_name: 'issuer_organization_id', label: 'Issuer', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'organization', sort_order: 44, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-counterparty_organization_id', object_api_name: 'treasury_transaction', api_name: 'counterparty_organization_id', label: 'Counterparty', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'organization', sort_order: 45, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-converted_from_id', object_api_name: 'treasury_transaction', api_name: 'converted_from_id', label: 'Converted from', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'treasury_transaction', sort_order: 55, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-notes', object_api_name: 'treasury_transaction', api_name: 'notes', label: 'Notes', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 50, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-external_id', object_api_name: 'treasury_transaction', api_name: 'external_id', label: 'External id', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 60, active: true, zone_role: 'header' },
  { id: 'fld-treasury_transaction-line_description', object_api_name: 'treasury_transaction', api_name: 'line_description', label: 'Line description', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-treasury_transaction-line_quantity', object_api_name: 'treasury_transaction', api_name: 'line_quantity', label: 'Quantity', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 71, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-treasury_transaction-line_unit_price', object_api_name: 'treasury_transaction', api_name: 'line_unit_price', label: 'Unit price', data_type: 'currency', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 72, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-treasury_transaction-line_total', object_api_name: 'treasury_transaction', api_name: 'line_total', label: 'Line total', data_type: 'currency', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 73, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-treasury_transaction-line_product_id', object_api_name: 'treasury_transaction', api_name: 'line_product_id', label: 'Product', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'production_product', sort_order: 74, active: true, zone_role: 'list', show_in_column: true },
  ...
  { id: 'fld-contact-email_label', object_api_name: 'contact', api_name: 'email_label', label: 'Email label', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 32, active: true },
  { id: 'fld-contact-is_primary', object_api_name: 'contact', api_name: 'is_primary', label: 'Primary', data_type: 'boolean', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 33, active: true },
  ...
  { id: 'fld-organization-phone', object_api_name: 'organization', api_name: 'phone', label: 'Phone', data_type: 'phone', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 82, active: true },
  { id: 'fld-organization-email', object_api_name: 'organization', api_name: 'email', label: 'Email', data_type: 'email', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 84, active: true },
  ...
  { id: 'fld-event-occurs_at', object_api_name: 'event', api_name: 'occurs_at', label: 'Occurs at', data_type: 'datetime', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 35, active: true },
  ...
  { id: 'fld-schedule-integration_id', object_api_name: 'schedule', api_name: 'integration_id', label: 'Integration', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'vendor_integration', sort_order: 25, active: true },
  { id: 'fld-schedule-location_id', object_api_name: 'schedule', api_name: 'location_id', label: 'Location', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'location', sort_order: 26, active: true },
  { id: 'fld-schedule-occurs_at', object_api_name: 'schedule', api_name: 'occurs_at', label: 'Occurs at', data_type: 'datetime', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 72, active: true },
  { id: 'fld-schedule-custom_slots', object_api_name: 'schedule', api_name: 'custom_slots', label: 'Custom times', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 74, active: true },
  // I5.6.35 S-4 (2026-09-12): Statistics -> Environment header + lines model.
  // Header config fields (zone_role header) define the graph: scale axis
  // (start/end/step), frequency window (type/start/qty), series behavior.
  // Line fields (zone_role list) describe captured stat_line rows. Validation
  // lives in src/lib/statistics/model.ts - the ONE layer shared by the UI
  // capture form and the capture API (locked contract
  // state_statistics_environment.md). Legacy flat fields (value/unit/category/
  // scale/series) are retired; the public seeder/reader keep their legacy
  // shape (S-6 compatibility, see src/lib/public/site-content.ts).
  { id: 'fld-environment_stat-name', object_api_name: 'statistics', api_name: 'name', label: 'Name', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 10, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-scale_name', object_api_name: 'statistics', api_name: 'scale_name', label: 'Scale Name', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 15, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-scale_start', object_api_name: 'statistics', api_name: 'scale_start', label: 'Scale Low', data_type: 'number', is_system: true, is_required: true, default_value: '0', value_set_api_name: null, lookup_object_api_name: null, sort_order: 20, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-scale_end', object_api_name: 'statistics', api_name: 'scale_end', label: 'Scale High', data_type: 'number', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 30, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-scale_step', object_api_name: 'statistics', api_name: 'scale_step', label: 'Scale Division', data_type: 'number', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 40, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-frequency_type', object_api_name: 'statistics', api_name: 'frequency_type', label: 'Frequency type', data_type: 'picklist', is_system: true, is_required: true, default_value: 'day', value_set_api_name: 'stat_frequency_type', lookup_object_api_name: null, sort_order: 50, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-frequency_start', object_api_name: 'statistics', api_name: 'frequency_start', label: 'Frequency start', data_type: 'text', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 60, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-frequency_qty', object_api_name: 'statistics', api_name: 'frequency_qty', label: 'Frequency quantity', data_type: 'number', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 70, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-start_datetime', object_api_name: 'statistics', api_name: 'start_datetime', label: 'Start datetime', data_type: 'datetime', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 75, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-series_mode', object_api_name: 'statistics', api_name: 'series_mode', label: 'Series mode', data_type: 'picklist', is_system: true, is_required: true, default_value: 'dynamic', value_set_api_name: 'stat_series_mode', lookup_object_api_name: null, sort_order: 80, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-status', object_api_name: 'statistics', api_name: 'status', label: 'Status', data_type: 'picklist', is_system: true, is_required: false, default_value: 'active', value_set_api_name: 'record_status', lookup_object_api_name: null, sort_order: 90, active: false, zone_role: 'header' },
  { id: 'fld-environment_stat-line_value', object_api_name: 'statistics', api_name: 'line_value', label: 'Line value', data_type: 'number', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 100, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-environment_stat-line_slot', object_api_name: 'statistics', api_name: 'line_slot', label: 'Line slot', data_type: 'number', is_system: true, is_required: true, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 110, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-environment_stat-line_stamp', object_api_name: 'statistics', api_name: 'line_stamp', label: 'Stamp', data_type: 'datetime', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 115, active: true, zone_role: 'list', show_in_column: true },
  { id: 'fld-environment_stat-created_by', object_api_name: 'statistics', api_name: 'created_by', label: 'Created by', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'user', sort_order: 200, active: true, zone_role: 'header' },
  { id: 'fld-environment_stat-last_modified_by', object_api_name: 'statistics', api_name: 'last_modified_by', label: 'Last modified by', data_type: 'lookup', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: 'user', sort_order: 210, active: true, zone_role: 'header' },
  // Legacy flat-stat fields (Name/Value/Unit/Category/Scale/Series). Hidden,
  // not deleted — Frequency type replaced Scale; captured lines replaced Series.
  { id: 'fld-environment_stat-value', object_api_name: 'statistics', api_name: 'value', label: 'Value', data_type: 'number', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 900, active: false, zone_role: 'header' },
  { id: 'fld-environment_stat-unit', object_api_name: 'statistics', api_name: 'unit', label: 'Unit', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 910, active: false, zone_role: 'header' },
  { id: 'fld-environment_stat-category', object_api_name: 'statistics', api_name: 'category', label: 'Category', data_type: 'text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 920, active: false, zone_role: 'header' },
  { id: 'fld-environment_stat-scale', object_api_name: 'statistics', api_name: 'scale', label: 'Scale', data_type: 'picklist', is_system: true, is_required: false, default_value: 'month', value_set_api_name: 'stat_scale', lookup_object_api_name: null, sort_order: 930, active: false, zone_role: 'header' },
  { id: 'fld-environment_stat-series', object_api_name: 'statistics', api_name: 'series', label: 'Series', data_type: 'long_text', is_system: true, is_required: false, default_value: null, value_set_api_name: null, lookup_object_api_name: null, sort_order: 940, active: false, zone_role: 'header' },
...
function withPlatformAudit(fields: FieldDefinition[]): FieldDefinition[] {
  const labelByApi = new Map(PLATFORM_DEFAULT_FIELDS.map((s) => [s.api_name, s.label]));
  const normalized = fields.map((f) => {
    const locked = labelByApi.get(f.api_name);
    if (!locked || f.label === locked) return f;
    return { ...f, label: locked };
  });
  const objects = [...new Set(normalized.map((f) => f.object_api_name))];
  const have = new Set(normalized.map((f) => `${f.object_api_name}::${f.api_name}`));
  const extra: FieldDefinition[] = [];
  for (const object_api_name of objects) {
    for (const seed of PLATFORM_DEFAULT_FIELDS) {
      if (have.has(`${object_api_name}::${seed.api_name}`)) continue;
      extra.push({
        id: `fld-${object_api_name}-${seed.api_name}`,
        object_api_name,
        ...
        default_value: null,
        value_set_api_name: null,
        lookup_object_api_name: seed.lookup_object_api_name,
        sort_order: seed.sort_order,
        active: true,
        zone_role: "header",
      });
      have.add(`${object_api_name}::${seed.api_name}`);
    }
  }
...
export function applyCatalogOverlay(overlay: {
  ...
  const foldFields = (rows: FieldDefinition[] | undefined) =>
    (rows ?? []).map((row) => ({
      ...row,
      object_api_name: foldRecordTypeApiName(row.object_api_name),
    }));
  const foldLayouts = (rows: LayoutDefinition[] | undefined) =>
    (rows ?? []).map((row) => ({
      ...row,
      object_api_name: foldRecordTypeApiName(row.object_api_name),
    }));
  ...
  catalogLive().layouts = merge(layoutDefinitions, foldLayouts(overlay.layouts), layoutKey, () => systemSeedWins);
...
export function listFieldDefinitions(objectApiName: string): FieldDefinition[] {
  ensureCatalogHydrated();
  const object = foldRecordTypeApiName(objectApiName);
  return catalogLive().fields
    .filter((f) => f.object_api_name === object && f.active)
    .sort((a, b) => a.sort_order - b.sort_order);
}
...
export function ensureObjectForRecordType(input: {
  ...
  // Seed locked platform defaults + status so zone subtabs render real catalog fields.
  const ensureField = (
    apiName: string,
    label: string,
    sortOrder: number,
  ...
  for (const seed of PLATFORM_DEFAULT_FIELDS) {
    ensureField(seed.api_name, seed.label, seed.sort_order, {
      data_type: seed.data_type,
      required: seed.is_required,
