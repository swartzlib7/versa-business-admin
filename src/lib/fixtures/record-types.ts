...
export const recordTypes: RecordTypeDefinition[] = [
  ...
  },
  {
    ...
    label: 'Custom',
    description:
      'Parent for Environment Custom listings: Statistics, Cycle Strip, and Pages. Configuration and Rendering Drivers live on Page Builder → Elements.',
  ...
  },
  {
    ...
    label: 'Cycle Strip',
    description:
      'Numbered visitor cycle steps. The heading is stored on the standard Name field.',
    parent_kind: 'environment',
    parent_api_name: 'custom',
    structure: 'list',
    show_as_tab: true,
  ...
  },
  {
    ...
    description:
      'Catalog of Page Builder code renderers. Header is record type + shape; lines are reusable UI recipes. Listed on Page Builder → Elements, not Environment → Custom.',
    parent_kind: 'environment',
    parent_api_name: 'custom',
    structure: 'header_lines',
    show_as_tab: false,
  ...
  },
  {
    ...
    label: 'Configuration',
    description: 'Instance on a Cell: this record × this driver recipe. Listed on Page Builder → Elements, not Environment → Custom.',
    parent_kind: 'environment',
    parent_api_name: 'custom',
    structure: 'list',
    show_as_tab: false,
