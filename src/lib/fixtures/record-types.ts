...
export const recordTypes: RecordTypeDefinition[] = [
  {
    ...
    description: 'Named operational records under Public (replaces anonymous Records tab).',
    parent_kind: 'faculty',
    ...
    active: true,
    is_system: true,
    object_api_name: 'public_item',
  },
  {
    id: 'rt-comms-item',
    api_name: 'comms_item',
    label: 'Communications records',
    description: 'Operational records under Communications.',
    parent_kind: 'faculty',
    ...
    active: true,
    is_system: true,
    object_api_name: 'comms_item',
  },
  {
    id: 'rt-dissemination-item',
    api_name: 'dissemination_item',
    label: 'Dissemination records',
    description: 'Operational records under Dissemination.',
    parent_kind: 'faculty',
    ...
    active: true,
    is_system: true,
    object_api_name: 'dissemination_item',
  },
  {
    id: 'rt-treasury-item',
    api_name: 'treasury_item',
    label: 'Treasury records',
    description: 'Operational records under Treasury.',
    parent_kind: 'faculty',
    ...
    active: true,
    is_system: true,
    object_api_name: 'treasury_item',
  },
  {
    id: 'rt-qualification-item',
    api_name: 'qualification_item',
    label: 'Qualification records',
    description: 'Baseline qualification list; split via Records Editor as needed.',
    parent_kind: 'faculty',
    ...
    active: true,
    is_system: true,
    object_api_name: 'qualification_item',
  },
];
