...
export const recordTypes: RecordTypeDefinition[] = [
  {
    ...
    active: true,
    is_system: true,
    object_api_name: 'public_record',
  },
  {
    id: 'rt-communication_log',
    ...
    active: true,
    is_system: true,
    object_api_name: 'communication_log',
  },
  {
    id: 'rt-dissemination_channel',
    ...
    active: true,
    is_system: true,
    object_api_name: 'dissemination_channel',
  },
  {
    id: 'rt-treasury_item',
  ...
  },
  {
    ...
    active: true,
    is_system: true,
    object_api_name: 'qualification_record',
  },
];
